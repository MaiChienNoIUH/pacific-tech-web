      ...
      <Container>
        <div className="relative z-10 text-left max-w-4xl">
          <motion.span
            ...
            className="inline-block px-5 py-2 rounded-full bg-blue-500/10 text-blue-600 border border-blue-500/20 mb-6"
          >
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-[#0b1a3a] leading-tight mb-8 tracking-tight">
            ...
            AI Systems <span className="text-blue-600">That Scale</span>
          </h1>
